...
$pretrained_model = "H:\ComfyUI\models\checkpoints\majicmixRealistic_v7.safetensors" # base model path | 底模路径
$train_data_dir = "./train/houtu" # train dataset path | 训练数据集路径
$reg_data_dir = "" # directory for regularization images | 正则化数据集路径，默认不使用正则化图像。

# Network settings | 模型大小设置
...
$batch_size = 2 # batch size | batch 大小
...
$lr_warmup_steps = 2 # warmup steps | 学习率预热步数，lr_scheduler 为 constant 或 adafactor 时该值需要设为0。
...
$output_name = "sd15-houtu-v1" # output model name | 模型保存名称
